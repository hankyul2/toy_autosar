...
#elif defined(APP_LOWBEAM_START_SEC_CODE)
#undef APP_LOWBEAM_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(APP_LOWBEAM_STOP_SEC_CODE)
#undef APP_LOWBEAM_STOP_SEC_CODE
