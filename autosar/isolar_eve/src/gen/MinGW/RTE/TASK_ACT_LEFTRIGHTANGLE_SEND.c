/** @file     TASK_ACT_LEFTRIGHTANGLE_SEND.c
  * 
  * @brief    Task TASK_ACT_LEFTRIGHTANGLE_SEND body
  * 
...
#include "TASK_ACT_LEFTRIGHTANGLE_SEND.h"
...
extern CONST(Rte_QTaskType, RTE_DATA) Rte_Queue_CPT_ACT_LEFTRIGHT_MOTOR_P_LEFTRIGHTANGLE_TO_ECU_ABS_AFS_OPER_ACT_TO_ECU;
...
#include "MemMap.h" /*lint !e537 permit multiple inclusion */
TASK(TASK_ACT_LEFTRIGHTANGLE_SEND)
{
   ...
   {
      /* Box: CPT_ACT_LEFTRIGHT_MOTOR begin */
      /* P_LEFTRIGHTANGLE_TO_ECU_ABS_AFS */
      {
         ...
         for (;;) {
            rtn = Rte_ReadQueue(&Rte_Queue_CPT_ACT_LEFTRIGHT_MOTOR_P_LEFTRIGHTANGLE_TO_ECU_ABS_AFS_OPER_ACT_TO_ECU.cmn, &srvQEl);
            if ( ( ((VAR(Std_ReturnType, AUTOMATIC))RTE_E_OK) == rtn ) || ( ((VAR(Std_ReturnType, AUTOMATIC))RTE_E_LOST_DATA) == rtn ) )
            {
               ...
               RE_LEFTRIGHTANGLE_SEND(&cliQEl.ADP_ACT_TO_ECU);
               /* SpecReq: Measurement point CS begin */
               /* SpecReq: Measurement point CS end */
