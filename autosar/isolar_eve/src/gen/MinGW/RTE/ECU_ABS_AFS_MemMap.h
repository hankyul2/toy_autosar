...
#elif defined(ECU_ABS_AFS_START_SEC_CODE)
#undef ECU_ABS_AFS_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(ECU_ABS_AFS_STOP_SEC_CODE)
#undef ECU_ABS_AFS_STOP_SEC_CODE
