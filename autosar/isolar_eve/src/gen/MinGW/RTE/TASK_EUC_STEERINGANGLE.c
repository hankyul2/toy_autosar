/** @file     TASK_EUC_STEERINGANGLE.c
  * 
  * @brief    Task TASK_EUC_STEERINGANGLE body
  * 
...
#include "TASK_EUC_STEERINGANGLE.h"
...
extern CONST(Rte_QTaskType, RTE_DATA) Rte_Queue_CPT_ECU_ABS_AFS_P_STEERINGALGLE_TO_SENSOR_STERRINGANGLE_OPER_ECU_TO_SENSOR;
#define RTE_STOP_SEC_CONST_UNSPECIFIED
#include "MemMap.h" /*lint !e537 permit multiple inclusion */

#define RTE_START_SEC_VAR_8BIT
#include "MemMap.h" /*lint !e537 permit multiple inclusion */
extern VAR(uint8, RTE_DATA) Rte_Var_CPT_SENSOR_STEERINGANGLE_R_STEERINGANGLE_FROM_ECU_ABS_AFS_OPER_ECU_TO_SENSOR_outstanding;
...
TASK(TASK_EUC_STEERINGANGLE)
{
   ...
   /* Box: Implicit Buffer Fill end */
   {
      ...
      /* P_STEERINGALGLE_TO_SENSOR_STERRINGANGLE */
      {
         ...
         for (;;) {
            rtn = Rte_ReadQueue(&Rte_Queue_CPT_ECU_ABS_AFS_P_STEERINGALGLE_TO_SENSOR_STERRINGANGLE_OPER_ECU_TO_SENSOR.cmn, &srvQEl);
            if ( ( ((VAR(Std_ReturnType, AUTOMATIC))RTE_E_OK) == rtn ) || ( ((VAR(Std_ReturnType, AUTOMATIC))RTE_E_LOST_DATA) == rtn ) )
            {
               ...
               RE_ECU_STEERINGANGLE(&cliQEl.ADP_ECU_TO_SENSOR);
               /* SpecReq: Measurement point CS begin */
               /* SpecReq: Measurement point CS end */
