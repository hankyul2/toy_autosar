...
#elif defined(ACT_HIGHBEAM_START_SEC_CODE)
#undef ACT_HIGHBEAM_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(ACT_HIGHBEAM_STOP_SEC_CODE)
#undef ACT_HIGHBEAM_STOP_SEC_CODE
