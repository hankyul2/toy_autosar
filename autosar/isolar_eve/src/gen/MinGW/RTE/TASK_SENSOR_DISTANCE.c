/** @file     TASK_SENSOR_DISTANCE.c
  * 
  * @brief    Task TASK_SENSOR_DISTANCE body
  * 
...
#include "TASK_SENSOR_DISTANCE.h"
...
TASK(TASK_SENSOR_DISTANCE)
{
   ...
   {
      /* Box: CPT_SENSOR_DISTANCE begin */
      RE_DISTANCE();
      /* Box: CPT_SENSOR_DISTANCE end */
   }
   /* Box: Implicit Buffer Flush begin */
   /* Box: Implicit Buffer Flush end */
   TerminateTask();
} /* TASK_SENSOR_DISTANCE */
