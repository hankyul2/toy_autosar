/** @file     TASK_ACT_HIGHBEAM_RECEIVE.c
  * 
  * @brief    Task TASK_ACT_HIGHBEAM_RECEIVE body
  * 
...
#include "TASK_ACT_HIGHBEAM_RECEIVE.h"
...
extern VAR(Rte_REActCounterType, RTE_DATA) Rte_ActCount_CPT_ACT_HIGHBEAM_DRE_HIGHBEAM_RECEIVE;
...
#include "MemMap.h" /*lint !e537 permit multiple inclusion */
TASK(TASK_ACT_HIGHBEAM_RECEIVE)
{
   ...
   if ( Rte_ActCount_CPT_ACT_HIGHBEAM_DRE_HIGHBEAM_RECEIVE != FALSE )
   {
      Rte_ActCount_CPT_ACT_HIGHBEAM_DRE_HIGHBEAM_RECEIVE = FALSE;
      RE_HIGHBEAM_RECEIVE();
   }
