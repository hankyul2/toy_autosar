...
#elif defined(ACT_LOWBEAM_START_SEC_CODE)
#undef ACT_LOWBEAM_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(ACT_LOWBEAM_STOP_SEC_CODE)
#undef ACT_LOWBEAM_STOP_SEC_CODE
