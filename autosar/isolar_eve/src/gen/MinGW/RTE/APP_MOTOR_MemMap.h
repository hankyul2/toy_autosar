...
#elif defined(APP_MOTOR_START_SEC_CODE)
#undef APP_MOTOR_START_SEC_CODE
#define RTE_START_SEC_APPL_CODE
#elif defined(APP_MOTOR_STOP_SEC_CODE)
#undef APP_MOTOR_STOP_SEC_CODE
